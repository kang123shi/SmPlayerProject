...
public class StringUtil {
	...
	public static boolean isPhone(String phone) {
		...
		Pattern p = Pattern.compile("^((13[0-9])|(15[^4,\\D])|(18[0-4,5-9])|(17[0-9]))\\d{8}$");
		currentString = phone;
	...
	public static boolean isBase64Code(String s){

		String fromBase = getFromBASE64(s);
		String toBase = getBASE64(fromBase);
		if (toBase.equals(s)){
			return true;
		}else {
			return false;
